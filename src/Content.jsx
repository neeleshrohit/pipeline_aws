    ...
    >
          ...
          <div>
            ...
            <h2 className="">
              <span
                ...
                style={{
                  backgroundImage: "linear-gradient(to red,lightblue,red)",
          ...
          <Result
            ...
            title={
              <h2>
                ...
                >
                  Sorry, you are go to login page.
      ...
      >
        <Button
          ...
          className="ant-card-hoverable border-0 rounded rounded-8"
          style={{
            backgroundImage:"linear-gradient(to right,lightblue,red)",
            height: "50px",
        ...
        >
          <b style={{ fontSize: "20px", color:"white", }}>Start Game</b>
        </Button>
      </div>
      {isplay && (
        <PlayGame
