...
export default function PlayGame({ setPlay, islogin, user, setUser }) {
  ...
  return (
    ...
    >
      <Card
        style={{
          backgroundImage: "linear-gradient(180deg, red,blue, red)",
          ...
          <div className="d-block">
            <h2 className="">
              <span
                ...
                style={{
                  backgroundImage: "linear-gradient(to right,grey, #391085)",
        ...
        <div>
          ...
          <div className="d-flex justify-content-around mt-3">
            ...
            <Button
              ...
              style={{
                backgroundImage: "linear-gradient(to right,lightblue,#722ed1)",
                height: "50px",
                width: "150px",
              }}
              onClick={() => {
